    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "vide") {
                ...
                var table_affichage = " <table class='table table-striped  m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Adresse</th><th>Emplacement</th><th>Province</th></thead><tbody>";
