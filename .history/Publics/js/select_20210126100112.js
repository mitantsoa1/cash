        ...
        success: function(data) {
            if (data != "") {
                ...
                for (var i = 0; i < data.length - 2; i++) {
                    table_affichage = table_affichage + "<tr><td>" + data[i].operateur + "</td><td>" + data[i].type + "</td><td>" + data[i].montant + "</td><td>" + data[i].numero + "</td><td>" + data[i].observation + "</td><td>" + data[i].frais + "</td><td>" + data[i].commission + "</td><td>" + data[i].lieu + "</td><td>" + data[i].date + "</td></tr>";
                }
