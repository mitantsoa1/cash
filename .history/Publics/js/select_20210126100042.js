    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "rien") {
                ...
                var table_affichage = "<div class='table_trans_recherche'> <table class='table table-striped affichage_depot m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Operateur</th><th>Mon numero</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Lieu</th><th>Date</th></thead><tbody>";
                for (var i = 0; i < data.length; i++) {
                    table_affichage = table_affichage + "<tr><td>" + data[i].operateur + "</td><td>" + data[i].number + "</td><td>" + data[i].type + "</td><td>" + data[i].montant + "</td><td>" + data[i].numero + "</td><td>" + data[i].observation + "</td><td>" + data[i].frais + "</td><td>" + data[i].lieu + "</td><td>" + data[i].date;
                }
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "") {
                ...
                console.log(data);
                var table_affichage = "<table class='table table-striped affiche_etat'><thead><th>Operateur</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Commission</th><th>Lieu</th><th>Date</th></thead><tbody>";
                for (var i = 0; i < data.length - 2; i++) {
                    table_affichage = table_affichage + "<tr><td>" + data[i].operateur + "</td><td>" + data[i].type + "</td><td>" + data[i].montant + "</td><td>" + data[i].numero + "</td><td>" + data[i].observation + "</td><td>" + data[i].frais + "</td><td>" + data[i].commission + "</td><td>" + data[i].lieu + "</td><td>" + data[i].date + "</td>";
                }
                table_affichage += table_affichage + "</tr><tr><td>" + " " + "</td><td>" + " " + "</td><td>" + " " + "</td><td>" + " " + "</td><td>" + " Total " + "</td><td>" + data[data.length - 2] + "</td><td>" + data[data.length - 1] + "</td><td>" + " " + "</td><td>" + " " + "</td>";
                table_affichage = table_affichage + "</tr></tbody></table>";
...
$('#btn_etat_recherche_depot').on('click', function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "") {
                var table_affichage = "<table class='table table-striped table-bordered table-responsive' id='table_etat'><thead><th>Mon numero</th><th>Montant</th><th>description</th><th>date</th></thead><tbody>";
                for (var i = 0; i < data.length; i++) {
