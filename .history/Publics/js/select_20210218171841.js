...
function transaction() {
    ...
    $.ajax({
        ...
        success: function(data) {
            // console.log(data);
            var table_affichage = "<div class='tran'> <table class='table table-striped affichage_depot m-t-10' id='tableId' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Operateur</th><th>Mon numero</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Commission</th><th>Lieu</th><th>Date</th><th>Actions</th></thead><tbody>";
            for (var i = 0; i < data.length; i++) {
