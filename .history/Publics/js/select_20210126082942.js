    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "rien") {
                ...
                var table_affichage = "<div class='table_trans_recherche' style='height: 200px;overflow: auto; width: 80vw;'> <table class='table table-striped affichage_depot m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Operateur</th><th>Mon numero</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Lieu</th><th>Date</th></thead><tbody>";
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "") {
                ...
                console.log(data);
                // var table_affichage = "<table class='table table-striped affichage_depot'><thead><th>Operateur</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Commission</th><th>Lieu</th><th>Date</th><th>Etat</th></thead><tbody>";
                // for (var i = 0; i < data.length; i++) {
                //     table_affichage = table_affichage + "<tr><td>" + data[i].operateur + "</td><td>" + data[i].type + "</td><td>" + data[i].montant + "</td><td>" + data[i].numero + "</td><td>" + data[i].observation + "</td><td>" + data[i].frais + "</td><td>" + data[i].commission + "</td><td>" + data[i].lieu + "</td><td>" + data[i].date + "</td><td>" + data[i].id;
                // }
