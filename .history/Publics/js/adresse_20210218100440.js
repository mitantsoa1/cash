...
$('#adresse_top').on('click', function() {
    $('#adresse_top').addClass('foc');
    $('#telephone').removeClass('foc');
...
$('#telephone').on('click', function() {
    $('#telephone').addClass('foc');
    $('#adresse_top').removeClass('foc');
    $('.entete').html('<h2 class="centre"><a href="#" id="adresse_top" class="foc"> Adresse </a>/<a href="#" class="" id="telephone"> Telephone </a></h2>');
