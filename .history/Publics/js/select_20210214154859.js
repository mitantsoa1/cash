...
$('#show-sidebar').on("click", function() {
    ...
    var cacher = document.createElement("div");
    cacher.addClass("site-cacher");
    $("body").html("cacher");
    $('.site-cacher').css({ "position": "absolute", "top": "0", "bottom": "0", "left": "0", "right": "0", "background": "red", "zIndex": "1111110" })
})
