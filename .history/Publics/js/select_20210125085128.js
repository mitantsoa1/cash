    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "rien") {
                ...
                var table_affichage = "<div style='height: 200px;overflow: auto; width: 119%;'> <table class='table table-striped affichage_depot m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Operateur</th><th>Mon numero</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Lieu</th><th>Date</th></thead><tbody>";
