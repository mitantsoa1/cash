    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "") {
                ...
                console.log(data);
                var table_affichage = "<table class='table table-striped affiche_etat'><thead><th>Operateur</th><th>Type</th><th>Montant</th><th>Numero</th><th>Observation</th><th>frais</th><th>Commission</th><th>Lieu</th><th>Date</th><th>Total Com</th><th>Total frais</th></thead><tbody>";
                for (var i = 0; i < data.length; i++) {
                    table_affichage = table_affichage + "<tr><td>" + data[i].operateur + "</td><td>" + data[i].type + "</td><td>" + data[i].montant + "</td><td>" + data[i].numero + "</td><td>" + data[i].observation + "</td><td>" + data[i].frais + "</td><td>" + data[i].commission + "</td><td>" + data[i].lieu + "</td><td>" + data[i].date + "</td><td>" + data[data.length - 2] + data[data.length - 1];
                }
                table_affichage += "<tr><td>total</td>+</tr>";
