    ...
    $.ajax({
        ...
        success: function(data) {
            if (data != "") {
                ...
                table_affichage1 = "<tr><td>" + " " + "</td><td class='rouge'>" + "  Total " + "</td><td>" + " " + "</td><td>" + data[data.length - 1] + " Ar</td><td>" + " " + "</td><td>" + " " + "</td><td class='rouge' >" + data[data.length - 3] + " Ar</td><td class='rouge'>" + data[data.length - 2] + " Ar</td><td>" + " " + "</td><td>" + " " + "</td>";
