...
<html lang="en">
    ...
    <body>
        ...
        <form class="form-group" id="form_compte">
            ...
            <label>Numero</label>
            <input type="tel" class="form-control tel num"  name="telephone" id="id_telephone" required>
...
?>
        ...
        <input type="text" class="form-control search"  placeholder="search..." id="Input">
