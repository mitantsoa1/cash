...
<html lang="en">
    ...
    <body>
        ...
        <form class="form-group" id="form_compte">
            ...
            <input type="text" class="form-control adresse"  name="adresse" required><br><br>

            <label>Emplacement</label>
            <input type="text" class="form-control" name="emplacement" id="emplacement" required=""><br><br>

            <label>Province</label><br>
            <input type="text" class="form-control" id="province" name="province" required><br><br>
