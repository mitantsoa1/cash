...
<div id="tr"></div>
	<div class="container forme">
	 <input type="hidden" class="in" id="ii" value="ici" >
				...
				<form class="form-group " id="form_compte">
					...
					<?php 
						...
						$tab = $db ->selectSP()
									->from("telephone")
									->executeSP();
						$select= '<select name="select_tel" id="select_tel" class="form-control telephone"><option selected="selected" value="'.$tab[0]->numero.'">'.$tab[0]->numero.'</option>';
					...
					<a href="#" class="btn btn-info btn-block hide" id="btn_compteC_modif">Modifier</a>
				</form>
