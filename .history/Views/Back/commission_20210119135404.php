	...
	$('#btn_recherche_com').on('click', function() {
		...
		$.ajax({
            ...
            success: function(data) {
                ...
                var table_affichage = "<div style='height: 200px;overflow: auto; width: 119%;'> <table class='table table-striped affichage_depot m-t-10' style='position: relative !important;'><thead style='position: sticky !important;z-index: 1000;'><th>Operateur</th><th>Montant min.</th><th>Montant max.</th><th>Com. depot</th><th>Com. retrait</th><th>Com. transfert</th></thead><tbody>";
