...
?>
<button class="btn btn-success " id="exportToExcel" onclick="exportTableToExcel('tableId')">export to excel</button>
	</div>
<!--
	...
	<button class="btn btn-success hide" id="exportToExcel" onclick="exportTableToExcel('table_trans')">export to excel</button>
