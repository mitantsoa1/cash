    ...
    <?php
        ...
        for ($i=0; $i < count($table); $i++) { 
            echo "<tr>
                    ...
                    <td>
                    <a href='#' id='effacerFr' class='m-l-4 glyphFr' data-toggle='tooltip' data-placement='bottom' title='effacer' onclick='suppr(".$table[$i]->id.")'> <i class='glyphicon glyphicon-trash'></i></a>
