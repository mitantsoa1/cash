...
<table class='table table-striped table-hover table-bordered' id='table_trans'>
        <thead>
            <th> Operateur</th>
            <th>Mon numero</th>
            <th> Type</th>
...
for ($i=0; $i < count($table); $i++) { 
    echo "<tr>
            ...
            <td>".$table[$i]->date."</td>
            <td>
				<a href='#' id='effacerCpt' class='m-l-4 glyph' data-toggle='tooltip' data-placement='left' title='effacer' onclick='supprTrs(".$table[$i]->id.")'> <i class='glyphicon glyphicon-trash'></i></a>
				<a href='#' id='modifierCpt' class='m-l-10 ' data-toggle='tooltip' data-placement='bottom' title='modifier' onclick='modifTrs(".$table[$i]->id.")'> <i class='glyphicon glyphicon-edit'></i></a>
			</td>
...
?>
<button class="btn btn-success " id="exportExcel" onclick="exportTableToExcel('table_trans')">export to excel</button>
	</div>
<!--
