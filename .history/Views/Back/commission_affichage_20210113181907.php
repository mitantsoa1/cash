<?php
        ...
        for ($i=0; $i < count($table); $i++) { 
            echo "<tr>
                    ...
                    <td>
                    <a href='#' id='effacerCom' data-toggle='tooltip' title='effacer' onclick='suppr(".$table[$i]->id.")'> <i class='glyphicon glyphicon-trash'></i></a>
                    <a href='#' id='modifierCom' class='m-l-10 ' data-toggle='tooltip' title='modifier' onclick='modif(".$table[$i]->id.")'> <i class='glyphicon glyphicon-edit'></i></a>
                    </td>
                </tr>";
        }
        echo "</tbody>
