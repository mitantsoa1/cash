...
<div class="container loginBox">
	<div class="row">
		...
		<form class="form-group" id="form_compte">
			<input type="hidden" id="id_frais">
<label>Montant_min</label>
					<input type="tel" name="montant_min" id="montant_min" class="form-control search" required><br><br>
					
				<label>Montant_max</label>

					<input type="tel" name="montant_max" id="montant_max"  class="form-control search" required><br><br>
				<label>Frais depot</label>
					<input type="tel" class="frD" name="frais_d" id="frais_d"  class="form-control search" required>
					
				<label>Frais retrait</label>
					<input type="tel" class="frR" name="frais_r" id="frais_r"  class="form-control search" required>
					
				<label>Frais transfert</label>
					<input type="tel" class="frT" name="frais_t" id="frais_t"  class="form-control search" required>
