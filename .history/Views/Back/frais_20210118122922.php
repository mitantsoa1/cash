...
<label>Montant_min</label>
				...
				<label>Frais depot</label>
					<input type="tel" class="frD" name="frais_d" id="frais_d"  class="form-control " required><br><br>
					
				<label>Frais retrait</label>
					<input type="tel" class="frR" name="frais_r" id="frais_r"  class="form-control " required><br><br>
					
				<label>Frais transfert</label>
					<input type="tel" class="frT" name="frais_t" id="frais_t"  class="form-control " required><br><br>
