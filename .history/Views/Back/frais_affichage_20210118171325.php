    ...
    <?php
        ...
        for ($i=0; $i < count($table); $i++) { 
            echo "<tr>
                    ...
                    <a href='#' id='modifierFr' class='m-l-10 ' data-toggle='tooltip' data-placement='right' title='modifier' onclick='modif(".$table[$i]->id.")'> <i class='glyphicon glyphicon-edit'></i></a>
                    </td>
                </tr>";
        }
        echo "</tbody>
