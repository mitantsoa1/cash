...
<label>Montant_min</label>
			...
			<a href="#" id="btn_frais" class=" btn btn-primary"><span></span><span></span><span></span><span></span> Inserer</a>
			<a href="#" id="btn_frais_modifier" class=" btn btn-warning" class="hide"><span></span><span></span><span></span><span></span> Modifier</a>
			<a href="#" id="btn_frais_afficher" class=" btn btn-info"><span></span><span></span><span></span><span></span> Afficher tous</a>
			<a href="#" id="btn_frais_cacher" class=" btn btn-primary" class="hide"><span></span><span></span><span></span><span></span> Cacher </a>
		</form>
		</div>
		<br><br><br>
		<div class="droite">
