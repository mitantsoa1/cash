...
<div class="container forme">
		<form class="form-group" id="form_transaction">
            <input type="hidden" id="id_transaction">
				...
				<select name="select_num" id="select_num" class="form-control select_numero dat">
						<?php
							$db = new Database();
							Database::init("localhost","cash","root","");
							$tab = $db ->selectSP()
			...
			<a href="#" id="btn_transaction_modif" class="btn btn-block btn-primary hide"><span></span><span></span><span></span><span></span> Modifier </a>
		</form>
