...
<input class="form-control" id="In_put" type="text" placeholder="Search..">
<?php 
    ...
    for ($i=0; $i < count($table); $i++) { 
    	echo "<tr>
    			...
    			<td>
				<a href='#' id='effacer' class='m-l-50'  data-toggle='tooltip' data-placement='bottom' title='effacer' onclick='effacer(".$table[$i]->id.")'> <i class='glyphicon glyphicon-trash'></i></a>
