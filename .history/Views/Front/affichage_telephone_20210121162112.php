...
<?php 
    ...
    for ($i=0; $i < count($table); $i++) { 
        echo "<tr>
    			...
    			<td>
				<a href='#' id='effacerTel' class='m-l-50 glyph'  data-toggle='tooltip' data-placement='bottom' title='effacer' onclick='effacer(".$table[$i]->id.")'> <i class='glyphicon glyphicon-trash'></i></a>
				<a href='#' id='modifierTel' class='m-l-50' data-toggle='tooltip'  data-placement='bottom' title='modifier' onclick='modifier(".$table[$i]->id.")'> <i class='glyphicon glyphicon-edit'></i></a>
    			</td>
    		</tr>";
    }
	echo "</tbody>
