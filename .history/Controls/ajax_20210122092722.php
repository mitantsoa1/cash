                    ...
                    if(isset($_POST['date_min'])){
                         ...
                         // for($i=0;$i<count($t);$i++){
                               $tab = $db->selectSP()
                                                  ...
                                                  ->where("date","<=")
                                                  ->et(["date"],[">="])
                                                  ->execute([$_POST['date_max'],$_POST['date_min']]);
                              for($j=0;$j<count($tab);$j++){
                                   $com +=$tab[$j]->commission;
                                   $frais +=$tab[$j]->frais;
                              }
                         
                    //     echo json_encode("'total commisssion='"+$com+"'&total frais='"+$fraise);
                        echo json_encode("'total commisssion='"+$com);
                    }
