...
<div class="page-wrapper chiller-theme toggled">
  ...
  <nav id="sidebar" class="sidebar-wrapper">
    <div class="sidebar-content">
      ...
      <div class="sidebar-header">
        <div class="user-pic">
          <img class="img-responsive img-rounded" src="Publics/images/dollar.png" alt="User picture">
        </div>
        <div class="user-info">
  ...
  <div class="col-md-10 col-md-offset-1 ">
           ...
           <div class="col-md-offset-4 col-md-4 solde_content">
                            <!-- contenu du solde -->
                              
            </div>

            <div class="col-md-10 col-md-offset-1 contenu">
                <!-- contenu -->
            </div>

            <div class=" col-md-10 affichage_depot_compte ">
                
                             <!-- contenu du depot dans la base  -->affichage_tableau
                            
            </div>
                
            <div class="col-md-10 col-md-offset-1 affichage_tableau adresse_content">
